...
export const entityResolvers: IResolvers = {
  Query: {
    ...
    // Bank Resolvers
    add65143: (_parent, { input }, { dataSources }) => ({
      data: dataSources.api65143.addEntity(input.entity, input.parent),
    }),
    list65143: (_parent, args, { dataSources }) => ({ data: dataSources.api65143.listEntity(args) }),
    get65143: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65143.getEntity(id) }),
    delete65143: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65143.deleteEntity(id) }),
    update65143: (_parent, { entity }, { dataSources }) => ({
      data: dataSources.api65143.updateEntity(entity),
    }),
    autoComplete65143: (_parent, params, { dataSources }) => ({
      data: dataSources.api65143.getAutoCompleteValues(params.input),
    }),

    // CashCollectionArea Resolvers
    add65144: (_parent, { input }, { dataSources }) => ({
      data: dataSources.api65144.addEntity(input.entity, input.parent),
    }),
    list65144: (_parent, args, { dataSources }) => ({ data: dataSources.api65144.listEntity(args) }),
    get65144: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65144.getEntity(id) }),
    delete65144: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65144.deleteEntity(id) }),
    update65144: (_parent, { entity }, { dataSources }) => ({
      data: dataSources.api65144.updateEntity(entity),
    }),
    autoComplete65144: (_parent, params, { dataSources }) => ({
      data: dataSources.api65144.getAutoCompleteValues(params.input),
    }),
    change65144: (_parent, params, { dataSources }): DispatchCustomActionResults =>
      dataSources.api65144.customAction_change(params.input),

    // Deposit Resolvers
    add65145: (_parent, { input }, { dataSources }) => ({
      data: dataSources.api65145.addEntity(input.entity, input.parent),
    }),
    list65145: (_parent, args, { dataSources }) => ({ data: dataSources.api65145.listEntity(args) }),
    get65145: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65145.getEntity(id) }),
    delete65145: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65145.deleteEntity(id) }),
    update65145: (_parent, { entity }, { dataSources }) => ({
      data: dataSources.api65145.updateEntity(entity),
    }),
    autoComplete65145: (_parent, params, { dataSources }) => ({
      data: dataSources.api65145.getAutoCompleteValues(params.input),
    }),

    // Withdraw Resolvers
    add65146: (_parent, { input }, { dataSources }) => ({
      data: dataSources.api65146.addEntity(input.entity, input.parent),
    }),
    list65146: (_parent, args, { dataSources }) => ({ data: dataSources.api65146.listEntity(args) }),
    get65146: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65146.getEntity(id) }),
    delete65146: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65146.deleteEntity(id) }),
    update65146: (_parent, { entity }, { dataSources }) => ({
      data: dataSources.api65146.updateEntity(entity),
    }),
    autoComplete65146: (_parent, params, { dataSources }) => ({
      data: dataSources.api65146.getAutoCompleteValues(params.input),
    }),

    // Insurance Resolvers
    add65147: (_parent, { input }, { dataSources }) => ({
      data: dataSources.api65147.addEntity(input.entity, input.parent),
    }),
    list65147: (_parent, args, { dataSources }) => ({ data: dataSources.api65147.listEntity(args) }),
    get65147: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65147.getEntity(id) }),
    delete65147: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65147.deleteEntity(id) }),
    update65147: (_parent, { entity }, { dataSources }) => ({
      data: dataSources.api65147.updateEntity(entity),
    }),
    autoComplete65147: (_parent, params, { dataSources }) => ({
      data: dataSources.api65147.getAutoCompleteValues(params.input),
    }),
    addNew65147: (_parent, params, { dataSources }): DispatchCustomActionResults =>
      dataSources.api65147.customAction_addNew(params.input),

    // LifeInsurance Resolvers
    add65148: (_parent, { input }, { dataSources }) => ({
      data: dataSources.api65148.addEntity(input.entity, input.parent),
    }),
    list65148: (_parent, args, { dataSources }) => ({ data: dataSources.api65148.listEntity(args) }),
    get65148: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65148.getEntity(id) }),
    delete65148: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65148.deleteEntity(id) }),
    update65148: (_parent, { entity }, { dataSources }) => ({
      data: dataSources.api65148.updateEntity(entity),
    }),
    autoComplete65148: (_parent, params, { dataSources }) => ({
      data: dataSources.api65148.getAutoCompleteValues(params.input),
    }),

    // VehicleInsurance Resolvers
    add65149: (_parent, { input }, { dataSources }) => ({
      data: dataSources.api65149.addEntity(input.entity, input.parent),
    }),
    list65149: (_parent, args, { dataSources }) => ({ data: dataSources.api65149.listEntity(args) }),
    get65149: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65149.getEntity(id) }),
    delete65149: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65149.deleteEntity(id) }),
    update65149: (_parent, { entity }, { dataSources }) => ({
      data: dataSources.api65149.updateEntity(entity),
    }),
    autoComplete65149: (_parent, params, { dataSources }) => ({
      data: dataSources.api65149.getAutoCompleteValues(params.input),
    }),

    // HealthInsurance Resolvers
    add65150: (_parent, { input }, { dataSources }) => ({
      data: dataSources.api65150.addEntity(input.entity, input.parent),
    }),
    list65150: (_parent, args, { dataSources }) => ({ data: dataSources.api65150.listEntity(args) }),
    get65150: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65150.getEntity(id) }),
    delete65150: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65150.deleteEntity(id) }),
    update65150: (_parent, { entity }, { dataSources }) => ({
      data: dataSources.api65150.updateEntity(entity),
    }),
    autoComplete65150: (_parent, params, { dataSources }) => ({
      data: dataSources.api65150.getAutoCompleteValues(params.input),
    }),

    // CarInsurance Resolvers
    add65151: (_parent, { input }, { dataSources }) => ({
      data: dataSources.api65151.addEntity(input.entity, input.parent),
    }),
    list65151: (_parent, args, { dataSources }) => ({ data: dataSources.api65151.listEntity(args) }),
    get65151: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65151.getEntity(id) }),
    delete65151: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65151.deleteEntity(id) }),
    update65151: (_parent, { entity }, { dataSources }) => ({
      data: dataSources.api65151.updateEntity(entity),
    }),
    autoComplete65151: (_parent, params, { dataSources }) => ({
      data: dataSources.api65151.getAutoCompleteValues(params.input),
    }),

    // TwoWheelerInsurance Resolvers
    add65152: (_parent, { input }, { dataSources }) => ({
      data: dataSources.api65152.addEntity(input.entity, input.parent),
    }),
    list65152: (_parent, args, { dataSources }) => ({ data: dataSources.api65152.listEntity(args) }),
    get65152: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65152.getEntity(id) }),
    delete65152: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65152.deleteEntity(id) }),
    update65152: (_parent, { entity }, { dataSources }) => ({
      data: dataSources.api65152.updateEntity(entity),
    }),
    autoComplete65152: (_parent, params, { dataSources }) => ({
      data: dataSources.api65152.getAutoCompleteValues(params.input),
    }),

    // Loan Resolvers
    add65153: (_parent, { input }, { dataSources }) => ({
      data: dataSources.api65153.addEntity(input.entity, input.parent),
    }),
    list65153: (_parent, args, { dataSources }) => ({ data: dataSources.api65153.listEntity(args) }),
    get65153: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65153.getEntity(id) }),
    delete65153: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65153.deleteEntity(id) }),
    update65153: (_parent, { entity }, { dataSources }) => ({
      data: dataSources.api65153.updateEntity(entity),
    }),
    autoComplete65153: (_parent, params, { dataSources }) => ({
      data: dataSources.api65153.getAutoCompleteValues(params.input),
    }),

    // AgricultureLoan Resolvers
    add65154: (_parent, { input }, { dataSources }) => ({
      data: dataSources.api65154.addEntity(input.entity, input.parent),
    }),
    list65154: (_parent, args, { dataSources }) => ({ data: dataSources.api65154.listEntity(args) }),
    get65154: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65154.getEntity(id) }),
    delete65154: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65154.deleteEntity(id) }),
    update65154: (_parent, { entity }, { dataSources }) => ({
      data: dataSources.api65154.updateEntity(entity),
    }),
    autoComplete65154: (_parent, params, { dataSources }) => ({
      data: dataSources.api65154.getAutoCompleteValues(params.input),
    }),

    // HomeLoan Resolvers
    add65155: (_parent, { input }, { dataSources }) => ({
      data: dataSources.api65155.addEntity(input.entity, input.parent),
    }),
    list65155: (_parent, args, { dataSources }) => ({ data: dataSources.api65155.listEntity(args) }),
    get65155: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65155.getEntity(id) }),
    delete65155: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65155.deleteEntity(id) }),
    update65155: (_parent, { entity }, { dataSources }) => ({
      data: dataSources.api65155.updateEntity(entity),
    }),
    autoComplete65155: (_parent, params, { dataSources }) => ({
      data: dataSources.api65155.getAutoCompleteValues(params.input),
    }),

    // VehicleLoan Resolvers
    add65156: (_parent, { input }, { dataSources }) => ({
      data: dataSources.api65156.addEntity(input.entity, input.parent),
    }),
    list65156: (_parent, args, { dataSources }) => ({ data: dataSources.api65156.listEntity(args) }),
    get65156: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65156.getEntity(id) }),
    delete65156: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65156.deleteEntity(id) }),
    update65156: (_parent, { entity }, { dataSources }) => ({
      data: dataSources.api65156.updateEntity(entity),
    }),
    autoComplete65156: (_parent, params, { dataSources }) => ({
      data: dataSources.api65156.getAutoCompleteValues(params.input),
    }),

    // Locker Resolvers
    add65157: (_parent, { input }, { dataSources }) => ({
      data: dataSources.api65157.addEntity(input.entity, input.parent),
    }),
    list65157: (_parent, args, { dataSources }) => ({ data: dataSources.api65157.listEntity(args) }),
    get65157: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65157.getEntity(id) }),
    delete65157: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65157.deleteEntity(id) }),
    update65157: (_parent, { entity }, { dataSources }) => ({
      data: dataSources.api65157.updateEntity(entity),
    }),
    autoComplete65157: (_parent, params, { dataSources }) => ({
      data: dataSources.api65157.getAutoCompleteValues(params.input),
    }),

    // DocumentsFiles Resolvers
    add65158: (_parent, { input }, { dataSources }) => ({
      data: dataSources.api65158.addEntity(input.entity, input.parent),
    }),
    list65158: (_parent, args, { dataSources }) => ({ data: dataSources.api65158.listEntity(args) }),
    get65158: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65158.getEntity(id) }),
    delete65158: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65158.deleteEntity(id) }),
    update65158: (_parent, { entity }, { dataSources }) => ({
      data: dataSources.api65158.updateEntity(entity),
    }),
    autoComplete65158: (_parent, params, { dataSources }) => ({
      data: dataSources.api65158.getAutoCompleteValues(params.input),
    }),

    // Gold Resolvers
    add65159: (_parent, { input }, { dataSources }) => ({
      data: dataSources.api65159.addEntity(input.entity, input.parent),
    }),
    list65159: (_parent, args, { dataSources }) => ({ data: dataSources.api65159.listEntity(args) }),
    get65159: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65159.getEntity(id) }),
    delete65159: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65159.deleteEntity(id) }),
    update65159: (_parent, { entity }, { dataSources }) => ({
      data: dataSources.api65159.updateEntity(entity),
    }),
    autoComplete65159: (_parent, params, { dataSources }) => ({
      data: dataSources.api65159.getAutoCompleteValues(params.input),
    }),

    // Cash Resolvers
    add65160: (_parent, { input }, { dataSources }) => ({
      data: dataSources.api65160.addEntity(input.entity, input.parent),
    }),
    list65160: (_parent, args, { dataSources }) => ({ data: dataSources.api65160.listEntity(args) }),
    get65160: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65160.getEntity(id) }),
    delete65160: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65160.deleteEntity(id) }),
    update65160: (_parent, { entity }, { dataSources }) => ({
      data: dataSources.api65160.updateEntity(entity),
    }),
    autoComplete65160: (_parent, params, { dataSources }) => ({
      data: dataSources.api65160.getAutoCompleteValues(params.input),
    }),

    // Policies Resolvers
    add65161: (_parent, { input }, { dataSources }) => ({
      data: dataSources.api65161.addEntity(input.entity, input.parent),
    }),
    list65161: (_parent, args, { dataSources }) => ({ data: dataSources.api65161.listEntity(args) }),
    get65161: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65161.getEntity(id) }),
    delete65161: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65161.deleteEntity(id) }),
    update65161: (_parent, { entity }, { dataSources }) => ({
      data: dataSources.api65161.updateEntity(entity),
    }),
    autoComplete65161: (_parent, params, { dataSources }) => ({
      data: dataSources.api65161.getAutoCompleteValues(params.input),
    }),

    // RecurringDeposit Resolvers
    add65162: (_parent, { input }, { dataSources }) => ({
      data: dataSources.api65162.addEntity(input.entity, input.parent),
    }),
    list65162: (_parent, args, { dataSources }) => ({ data: dataSources.api65162.listEntity(args) }),
    get65162: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65162.getEntity(id) }),
    delete65162: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65162.deleteEntity(id) }),
    update65162: (_parent, { entity }, { dataSources }) => ({
      data: dataSources.api65162.updateEntity(entity),
    }),
    autoComplete65162: (_parent, params, { dataSources }) => ({
      data: dataSources.api65162.getAutoCompleteValues(params.input),
    }),

    // FixedDeposit Resolvers
    add65163: (_parent, { input }, { dataSources }) => ({
      data: dataSources.api65163.addEntity(input.entity, input.parent),
    }),
    list65163: (_parent, args, { dataSources }) => ({ data: dataSources.api65163.listEntity(args) }),
    get65163: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65163.getEntity(id) }),
    delete65163: (_parent, { id }, { dataSources }) => ({ data: dataSources.api65163.deleteEntity(id) }),
    update65163: (_parent, { entity }, { dataSources }) => ({
      data: dataSources.api65163.updateEntity(entity),
    }),
    autoComplete65163: (_parent, params, { dataSources }) => ({
      data: dataSources.api65163.getAutoCompleteValues(params.input),
    }),
  },
};
