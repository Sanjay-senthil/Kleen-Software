...
import { ApiBank } from '../../custom/entityResolvers/api65143';
import { ApiCashCollectionArea } from '../../custom/entityResolvers/api65144';
import { ApiDeposit } from '../../custom/entityResolvers/api65145';
import { ApiWithdraw } from '../../custom/entityResolvers/api65146';
import { ApiInsurance } from '../../custom/entityResolvers/api65147';
import { ApiLifeInsurance } from '../../custom/entityResolvers/api65148';
import { ApiVehicleInsurance } from '../../custom/entityResolvers/api65149';
import { ApiHealthInsurance } from '../../custom/entityResolvers/api65150';
import { ApiCarInsurance } from '../../custom/entityResolvers/api65151';
import { ApiTwoWheelerInsurance } from '../../custom/entityResolvers/api65152';
import { ApiLoan } from '../../custom/entityResolvers/api65153';
import { ApiAgricultureLoan } from '../../custom/entityResolvers/api65154';
import { ApiHomeLoan } from '../../custom/entityResolvers/api65155';
import { ApiVehicleLoan } from '../../custom/entityResolvers/api65156';
import { ApiLocker } from '../../custom/entityResolvers/api65157';
import { ApiDocumentsFiles } from '../../custom/entityResolvers/api65158';
import { ApiGold } from '../../custom/entityResolvers/api65159';
import { ApiCash } from '../../custom/entityResolvers/api65160';
import { ApiPolicies } from '../../custom/entityResolvers/api65161';
import { ApiRecurringDeposit } from '../../custom/entityResolvers/api65162';
import { ApiFixedDeposit } from '../../custom/entityResolvers/api65163';
...
export const dataSources = (): Record<string, DataSource> => ({
  ...
  api65143: new ApiBank(),
  api65144: new ApiCashCollectionArea(),
  api65145: new ApiDeposit(),
  api65146: new ApiWithdraw(),
  api65147: new ApiInsurance(),
  api65148: new ApiLifeInsurance(),
  api65149: new ApiVehicleInsurance(),
  api65150: new ApiHealthInsurance(),
  api65151: new ApiCarInsurance(),
  api65152: new ApiTwoWheelerInsurance(),
  api65153: new ApiLoan(),
  api65154: new ApiAgricultureLoan(),
  api65155: new ApiHomeLoan(),
  api65156: new ApiVehicleLoan(),
  api65157: new ApiLocker(),
  api65158: new ApiDocumentsFiles(),
  api65159: new ApiGold(),
  api65160: new ApiCash(),
  api65161: new ApiPolicies(),
  api65162: new ApiRecurringDeposit(),
  api65163: new ApiFixedDeposit(),
});
