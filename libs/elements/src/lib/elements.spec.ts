...
describe('elements', () => {
  describe('get filter operators', () => {
    it(`should return the "${FilterOperation.Is}" and "${FilterOperation.IsNot}" operators for a categorical statistical type`, () => {
      expect(getFilterOperators('cafe').sort()).toEqual([FilterOperation.Is, FilterOperation.IsNot].sort());
    });

    it(`should only return "${FilterOperation.Is}", "${FilterOperation.IsNot}", "${FilterOperation.GreaterOrEqualThan}" and "${FilterOperation.LessOrEqualThan}" operators for an integer statistical type`, () => {
    ...
    it(`should return the "${FilterOperation.Is}", "${FilterOperation.IsNot}", "${FilterOperation.GreaterOrEqualThan}", "${FilterOperation.LessOrEqualThan}" and "${FilterOperation.RelativeDate}" operators for a timestamp statistical type`, () => {
