import { Action, GenericFunctions, OnInputChangeEvent, RegisterEvents, WidgetProps } from '@kleeen/types';
...
export type CellData = string | CellDisplayValue | JSX.Element | boolean | unknown;
