...
import { isNilOrEmpty, sortByName } from '@kleeen/common/utils';
...
export const ButtonFilter = ({
  ...
  const categoryFilterOptions = availableAttributesToFilter
    .map(({ name, statisticalType }) => ({
      displayName: getTranslationByThingName(name, translate),
      name,
