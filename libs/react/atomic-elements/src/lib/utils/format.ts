import { Attribute, ElementDisplayType, FormatProps, Transformation } from '@kleeen/types';
...
export const getAttributeFormatType = path<string>(['value', 'formatType']);
export const getAttributeTransformation = path<Transformation>(['value', 'transformation']);
